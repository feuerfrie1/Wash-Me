          ...
          <div className="footer__services">
            <nav className="footer__nav">
              ...
              <ul className="footer__nav-links">
                ...
                <a href="#services" className="footer__nav-link">Автомойка</a>
                </li>
                <li className="footer__nav-link">
                <a href="#services" className="footer__nav-link">Детейлинг</a>
                </li>
                <li className="footer__nav-link">
                <a href="#services" className="footer__nav-link">Оклейка</a>
                </li>
                <li className="footer__nav-link">
                <a href="#services" className="footer__nav-link">Шиномонтаж</a>
                </li>
              </ul>
            </nav>
          </div>
